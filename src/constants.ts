export const API_ENDPOINTS: Record<string, Record<string, string>> = {
  ...
  overtime: {
    config: "/xtra/jiaban/openapi/v1/getMaxVersionConfigList",
    types: "/xtra/jiaban/openapi/v1/findApproveType",
    groups: "/xtra/jiaban/openapi/v1/getGroupInfo",
    calc_duration: "/xtra/jiaban/openapi/v1/calculateDuration",
    upload: "/xtra/jiaban/openapi/v1/upload",
    submit: "/xtra/jiaban/openapi/v1/submitApprove",
    list: "/xtra/jiaban/openapi/v1/getMyApplyPageInfo",
  },
  leave: {
    config: "/xtra/qingjia/openapi/v1/maxVersionConfigList",
    types: "/xtra/qingjia/openapi/v1/enableLeaveTypeList",
    groups: "/xtra/qingjia/openapi/v1/attendanceGroupList",
    balance: "/xtra/qingjia/openapi/v1/personBalance",
    calc_times: "/xtra/qingjia/openapi/v1/times",
    upload: "/xtra/qingjia/openapi/v1/upload",
    submit: "/xtra/qingjia/openapi/v1/saveApply",
    list: "/xtra/qingjia/openapi/v1/myApplyPageInfo",
  },
  boardroom: {
    room_schedule: "/xtra/boardroom/openapi/v1/roomSchedule",
    room_list: "/xtra/boardroom/openapi/v1/roomList",
    room_detail: "/xtra/boardroom/openapi/v1/roomDetail",
    reserve: "/xtra/boardroom/openapi/v1/reserveRoom",
    reserve_detail: "/xtra/boardroom/openapi/v1/reserveDetail",
    reserve_cancel: "/xtra/boardroom/openapi/v1/reserveCancel",
    remove_bind: "/xtra/boardroom/openapi/v1/removeBind",
    reject_approve: "/xtra/boardroom/openapi/v1/rejectApprove",
    pending_approve_list: "/xtra/boardroom/openapi/v1/pendingApproveList",
    my_reserve_list: "/xtra/boardroom/openapi/v1/myReserveList",
    grading_list: "/xtra/boardroom/openapi/v1/gradingList",
    get_my_reserve_moom_list: "/xtra/boardroom/openapi/v1/getMyReserveMoomList",
    get_my_reserve_by_source: "/xtra/boardroom/openapi/v1/getMyReserveMoomListBySourceId",
    edit_reserve: "/xtra/boardroom/openapi/v1/editReserve",
    confirm_sign: "/xtra/boardroom/openapi/v1/confirmSign",
    change_approve: "/xtra/boardroom/openapi/v1/changeApprove",
    cancel: "/xtra/boardroom/openapi/v1/cancel",
    bind: "/xtra/boardroom/openapi/v1/bind",
    batch_approve: "/xtra/boardroom/openapi/v1/batchApprove",
    area_office_list: "/xtra/boardroom/openapi/v1/areaOfficeList",
    approve_detail: "/xtra/boardroom/openapi/v1/approveDetail",
    agree_approve: "/xtra/boardroom/openapi/v1/agreeApprove",
  },
  attendance: {
    associate_list: "/xtra/attendance/openapi/v1/outApply/getListByCondition",
    out_my_list: "/xtra/attendance/openapi/v1/outApply/myList",
    out_unused: "/xtra/attendance/openapi/v1/outApply/getUnusedOutClockList",
    out_submit: "/xtra/attendance/openapi/v1/outApply/submit",
    daily_stat: "/xtra/attendance/openapi/v1/dailyStat/getByTimeRange",
    clock_records: "/xtra/attendance/openapi/v1/clockRecord/getByTimeRange",
    staff_records: "/xtra/attendance/openapi/v1/clockRecord/staffClockRecord",
    group_info: "/xtra/attendance/openapi/v1/attendanceGroupInfo",
    makeup_count: "/xtra/attendance/openapi/v1/makeup/getUsedCount",
    abnormal_list: "/xtra/attendance/openapi/v1/abnormalAttendance/list",
    makeup_list: "/xtra/attendance/openapi/v1/makeup/myList",
    makeup_submit: "/xtra/attendance/openapi/v1/makeup/submit",
    download: "/xtra/attendance/openapi/v1/resource/download",
    upload_url: "/xtra/attendance/openapi/v1/resource/uploadUrl",
    upload: "/xtra/attendance/openapi/v1/resource/upload",
  },
};
